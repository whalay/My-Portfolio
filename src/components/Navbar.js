...
const Navbar = () => {
    ...
    return (
        ...
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-green-100'>
            ...
            {/* mobile menu */}
            <ul className={!nav ? 'hidden' : " flex flex-col justify-center items-center absolute top-0 left-o w-full bg-[#0a192f]  h-screen "}>
                <li className='py-6 text-4xl'>
                    <Link to="home" smooth={true} offset={50} duration={500} >
                        Home
                    </Link>
                </li>
                <li className='py-6 text-4xl'><Link to="about" smooth={true} offset={50} duration={500} >
                    About
                </Link></li>
            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    <li className='w-[160px] h-60px] flex justify-between items-center ml-[-100px] hover:ml-[10px] duration-300  bg-blue-700   '>
                        <a className='flex justify-between items-center w-full text-gray-300 py-1'
                            href="/">
